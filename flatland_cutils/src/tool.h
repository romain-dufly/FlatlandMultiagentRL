...
inline Cell_Transitions get_transitions(Position agent_position,
    ...
    int bits_new = (cell_transition >> ((3 - orientation.value) * 4));
    return (Cell_Transitions){static_cast<bool>((bits_new >> 3) & 1), static_cast<bool>((bits_new >> 2) & 1), static_cast<bool>((bits_new >> 1) & 1),
                              static_cast<bool>((bits_new)&1)};
};
